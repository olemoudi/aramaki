...
CUSTOM = "|regex|enkrypt|encrypt|crypt|clave|password|passwd|pwd|login|key|cipher|md5|sha1|hash|digest|sign|firma|b64|echo|https?:|://|\w+@\w+|email|aHR0|%2e%2e|random|certificate|cert|uuid|imei|imsi|sql|\d+\.\d+\.\d+\.\d+"
